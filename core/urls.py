...
urlpatterns = [
    ...
    path('newsletter/manage/', views.newsletter_manage, name='newsletter_manage'),
    path('newsletter/unsubscribe/manual/', views.newsletter_unsubscribe_manual, name='newsletter_unsubscribe_manual'),
